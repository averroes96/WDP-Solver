...
public class DashboardController implements Initializable {
    ...
    private void sliderAutoChangePictures() {
        ...
        Timeline sliderTimer = new Timeline(new KeyFrame(Duration.ZERO, e -> {
            ...
            ft.play();
            imgSlider.setImage(new Image(ClassLoader.class.getResourceAsStream("/Images/Sliders/" + counter + ".jpg"),800, 400, true, true));
    ...
    private void onTitle1() {
        styleBox(1);
        try {
            ItemPane = FXMLLoader.load(getClass().getResource("/Fxmls/SectionView.fxml"));
